...
<template>
    ...
    <b-field label="Assign Metalmancer">
        <b-select placeholder="Cultist" :disabled="!cultists.checkUnemployed()" v-model="metalmancerTab.metalmancerToAdd">
    ...
    <div v-if="metalmancerTab.golemType">
        ...
        <button class="button is-dark" @click="createGolemClick" :disabled="!cultists.checkCultistSpace() || !resources.checkIfCanAfford(metalmancer.getGolemCosts(metalmancerTab.golemType))">Create!</button>
    </div>
